...
@section('content')
    ...
    <div class="d-flex justify-content-center mt-5" style="color: #013d52;">
        <h1>Cadastrar novo aula</h1>
    </div>

    <div class="container mt-5">
        <form action="{{route('createLesson')}}" method="post" class="row g-3 shadow-lg p-3 mb-5 bg-body rounded">

            @csrf

            <div class="col-md-4">
                <label class="form-label">Número</label>
                <input type="text" class="form-control" name="lessonnumber" value="{{ old('lessonnumber') }}">
              </div>
  
              <div class="col-md-4">
                <label class="form-label">Tema</label>
                <input type="text" class="form-control" name="theme" value="{{ old('theme') }}">
              </div>
              ...
              <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" name="courseid" value="{{old('courseid')}}">
              </div>
  
              <div class="col-md-3">
                  <label class="form-label">Id do professor</label>
                  <input type="text" class="form-control" name="teacherid" value="{{old('teacherid')}}">
              </div>
