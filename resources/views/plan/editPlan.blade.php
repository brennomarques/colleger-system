...
@section('content')
    ...
    <div class="d-flex justify-content-center mt-5" style="color: #013d52;">
        <h1>Atualizar professor {{$plan->name}}</h1>
    </div>

    <div class="container mt-5">
        <form action="{{route('updatePlan', $plan->id)}}"  method="post" class="row g-3 shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" rows="3" name="note">{{ $plan->note }}"</textarea>
            </div>
