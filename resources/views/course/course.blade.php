            ...
            <tbody>
                @foreach ($courses as $course)
                    <tr>
                        ...
                        <td width="10"><a href="{{route('searchCourse', $course->id)}}" class="btn btn-outline-primary" title="Ver detalhes"><i class="fa fa-eye"></i></a></td>
                        <td width="10"><a href="{{route('editCourse', $course->id)}}" class="btn btn-outline-success" title="Editar"><i class="far fa-edit"></i></i></a></td>
